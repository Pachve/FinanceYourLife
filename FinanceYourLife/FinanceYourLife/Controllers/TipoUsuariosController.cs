...
namespace FinanceYourLife.Controllers
{
    public class TipoUsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDTipoUsuario,TipoPersona")] TipoUsuario tipoUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDTipoUsuario,TipoPersona")] TipoUsuario tipoUsuario)
        {
            if (ModelState.IsValid)
            {
